...
impl<'a, M> GlobalModuleContext<'a, M> where M: Module {
    ...
    pub fn create_function<S: Into<String>>(&self, named: S) -> anyhow::Result<FunctionWriter<File>> {
        FunctionGenerator::new(named.into(), &self.namespace_dir)
    }

    #[cfg(feature = "async_runtime")]
    pub fn create_function_async<S: Into<String>>(&self, named: S) -> anyhow::Result<crate::modules::functions::AsyncFunctionWriter<File>> {
